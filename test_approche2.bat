@echo off
echo ============================
echo TEST APPROCHE 2 (ONE QUEUE)
echo ============================
...
echo.
echo 1. DEMARRAGE HO CONSUMER (ONE QUEUE)
start cmd /k mvn exec:java "-Dexec.mainClass=com.tp2.HOConsumer_OneQueue"

timeout /t 15


echo.
echo 2. INSERT LIGNES DANS BO1
...
echo.
echo 3. DEMARRAGE BO1 PRODUCER (ONE QUEUE)
start cmd /k mvn exec:java "-Dexec.mainClass=com.tp2.BO1Producer_OneQueue"

timeout /t 10


echo.
echo 4. INSERT LIGNES DANS BO2
...
echo.
echo 5. DEMARRAGE BO2 PRODUCER (ONE QUEUE)
start cmd /k mvn exec:java "-Dexec.mainClass=com.tp2.BO2Producer_OneQueue"
